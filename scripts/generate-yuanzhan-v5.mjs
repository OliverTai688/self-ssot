...
const EXTENSIONS=['operating-spine','extensions','replies','journal-cockpit','timeline-participants','template-objects','operating-canvas','operating-forms','operating-converge','operating-persistence'];
...
fs.writeFileSync('src/components/yuanzhan/v5/styles.ts','// Original v5 CSS, isolated in Shadow DOM.\nexport const v5Styles = '+JSON.stringify(css+fs.readFileSync('src/components/yuanzhan/v5/additions.css','utf8')+fs.readFileSync('src/components/yuanzhan/v5/replies.css','utf8')+fs.readFileSync('src/components/yuanzhan/v5/journal-cockpit.css','utf8')+fs.readFileSync('src/components/yuanzhan/v5/timeline-participants.css','utf8')+fs.readFileSync('src/components/yuanzhan/v5/operating-canvas.css','utf8'))+'\n');
