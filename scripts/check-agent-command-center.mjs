...
const CLIENT_MARKERS = [
  "\"use client\"",
  "OWNEROS-UI-006-AGENTS-SURFACE",
  "data-owneros-slot=\"identity-mode-strip attention-header command-bar manual-ops-handoff\"",
  "data-owneros-slot=\"resource-index operation-selection\"",
  "data-owneros-slot=\"detail-pane\"",
  "data-owneros-slot=\"agent-proposal-pane proposal-review\"",
  "data-owneros-slot=\"proof-panel\"",
  "data-owneros-slot=\"records-audit agent-audit\"",
  "data-owneros-slot=\"settings-boundaries agent-boundary\"",
  "data-owneros-slot=\"module-readiness-drilldown\"",
  "Agent Command Center",
  "Choose a dry-run operation, inspect proof, prepare proposal, and keep audit boundaries visible.",
